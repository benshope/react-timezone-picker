...
function _default(options) {
  ...
  const managerPromise = (0, _managerConfig.default)(Object.assign({
    configType,
    outputDir,
    configDir,
    cache,
    corePresets: [require.resolve('./manager/manager-preset.js')]
  }, options)).then(config => new Promise((resolve, reject) => {
  ...
  const previewPromise = options.ignorePreview ? new Promise(resolve => resolve()) : (0, _config.default)(Object.assign({
    configType,
    outputDir,
    cache,
    ...
    const devMiddlewareOptions = Object.assign({
