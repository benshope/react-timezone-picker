...
exports.getTypeScriptRules = exports.getRules = void 0;
...
function isReactScriptsInstalled(requiredVersion = '2.0.0') {
  try {
    ...
    return !_semver.default.lt(reactScriptsJson.version, requiredVersion);
  } catch (e) {
    return false;
  }
}
...
const getTypeScriptRules = (webpackConfigRules, configDir) => {
  ...
  return [Object.assign({}, babelRule, {
...
function applyCRAWebpackConfig(baseConfig, configDir) {
  ...
  const extensions = [...cssExtensions, ...tsExtensions]; // Remove any rules from baseConfig that test true for any one of the extensions
