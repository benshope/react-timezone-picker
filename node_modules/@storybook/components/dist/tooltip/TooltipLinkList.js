...
TooltipLinkList.propTypes = {
  links: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    href: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.shape({})]),
    onClick: _propTypes.default.func,
    active: _propTypes.default.bool
  }).isRequired).isRequired,
  LinkWrapper: _propTypes.default.oneOfType([_propTypes.default.shape({}), _propTypes.default.func])
};
