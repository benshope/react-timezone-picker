...
var Scroller = _theming.styled.div({
  position: 'relative',
  overflow: 'auto'
}, function (_ref4) {
...
var Pre = _theming.styled.pre(function (_ref6) {
...
/*#__PURE__*/
function (_Component) {
  _inherits(CopyableCode, _Component);
  ...
  function CopyableCode() {
    ...
    _classCallCheck(this, CopyableCode);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(CopyableCode)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      copied: false
    };
    _this.formatCode = (0, _memoizerific.default)(2)(function (language, code) {
      var formattedCode = code;

      if (language === 'jsx') {
        try {
          formattedCode = (0, _jsBeautify.js)(code, {
            indent_size: 2,
  ...
  _createClass(CopyableCode, [{
    ...
    value: function render() {
      ...
      }, rest), format ? this.formatCode(language, children.trim()) : children.trim())), copyable ? _react.default.createElement(_ActionBar.ActionBar, {
        actionItems: [{
