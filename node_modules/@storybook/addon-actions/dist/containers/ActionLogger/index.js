...
function (_React$Component) {
  ...
  function ActionLogger() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ActionLogger)).call.apply(_getPrototypeOf2, [this].concat(args)));
    _this.state = {
      actions: []
    };
    ...
    _this.addAction = function (action) {
      ...
      if (previous && (0, _fastDeepEqual.default)(previous.data, action.data, {
        strict: true
      })) {
