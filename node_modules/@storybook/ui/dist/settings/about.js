...
_react.default.createElement(Upgrade, null, _react.default.createElement(_components.DocumentFormatting, null, _react.default.createElement("p", null, _react.default.createElement("b", null, "Upgrade all Storybook packages to latest:")), _react.default.createElement(_components.SyntaxHighlighter, {
  ...
  padded: true,
  bordered: true
}, "npx npm-check-updates '/storybook/' -u && yarn"), _react.default.createElement("p", null, "Alternatively, if you're using yarn run the following command, and check all Storybook related packages:"), _react.default.createElement(_components.SyntaxHighlighter, {
  language: "bash",
  copyable: true,
  padded: true,
  bordered: true
