...
var toHayStack = (0, _memoizerific.default)(2)(function (dataset) {
  return new _fuzzySearch.default(toList(dataset), ['kind', 'name', 'parameters.fileName', 'parameters.notes']);
});
