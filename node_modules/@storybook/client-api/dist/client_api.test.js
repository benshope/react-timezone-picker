...
describe('preview.client_api', function () {
  ...
  describe('getStorybook', function () {
    ...
    it('should ignore non-string ids from module', function () {
      var _getContext14 = getContext(),
          _getContext14$clientA = _getContext14.clientApi,
          getStorybook = _getContext14$clientA.getStorybook,
          storiesOf = _getContext14$clientA.storiesOf;
  ...
  describe('hot module loading', function () {
    ...
    it('should replace a kind when the module reloads', function () {
      var _getContext16 = getContext(),
          ...
          getStorybook = _getContext16$clientA.getStorybook;
